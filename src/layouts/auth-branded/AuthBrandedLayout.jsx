...
const Layout = () => {
  ...
  return <Fragment>
    <style>
      {`
          .branded-bg {
            background-image: url('${toAbsoluteUrl('/media/images/graduate.jpg')}');
          }
          .dark .branded-bg {
            background-image: url('${toAbsoluteUrl('/media/images/graduate.jpg')}');
          }
      ...
      <div className="lg:rounded-xl lg:border lg:border-gray-200 lg:m-5 order-1 lg:order-2 bg-top xxl:bg-center xl:bg-cover bg-no-repeat branded-bg">
        <div className="flex flex-col p-8 lg:p-16 gap-4">
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-2xl font-semibold text-white">Where Knowledge Meets Innovation</h3>
            <div className="text-base font-medium text-white">
              Unlock Your Potential for a Brighter Future.
              <br /> secure&nbsp;
              <span className="text-white font-semibold">Elevate Your Expertise, Transform Your Future.</span>
            </div>
          </div>
        </div>
      </div>
